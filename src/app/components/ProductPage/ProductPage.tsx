    ...
    >
      <div className={`${styles.productPage}`}>
        <div className={`${styles.productPage__header}`}>
          ...
          ></img>
          <div
            className={`${styles.header__searchQuery} montserrat fontWeight600`}
          >
            {query}
          </div>
        </div>
        ...
        <div className={`${styles.productPage__productDetails}`}>
          <div
            className={`${styles.productDetail__productName} inter fontWeight600`}
          >
            {name}
          </div>
        ...
        <div className={`${styles.productPage__footer}`}>
          ...
          <img
            className={`${styles.productPage__savedProduct}`}
            src={Resources.savedItems.src}
            onClick={async () => {
              await services.addToWishList(id, access_token);
